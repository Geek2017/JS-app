...
s += "open" === a[e].status ? "<tr id=" + a[e].id + '><td style="text-align: left; width:70%;padding-left:5px" class="inputshere">' + a[e].customer + '</td><td>&nbsp;</td><td style="width:20%;text-align:right;" class="ot-text">' + l + '&nbsp;&euro;</td><td style="width:10%;"><img class="pull-right" style="margin-top:3px;" src="images/arrow-right.png"></td></tr>' : "<tr id=" + a[e].id + '><td style="text-align: left;padding-left:5px" class="ot-close">' + a[e].customer + '</td><td class="ot-close">Closed</td><td class="ot-text" style="text-align:right;">' + l + '&nbsp;&euro;</td><td><img src="images/arrow-right.png" class="checkCust pull-right" style="margin-left:5px;" name="' + a[e].id + '"></td></tr>'
}
